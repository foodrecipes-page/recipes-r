...
Recipe cache shard for **[foodrecipes.page](https://foodrecipes.page)** — AI-generated recipes whose slug starts with **the letter 'r'**.
...
```
https://cdn.jsdelivr.net/gh/foodrecipes-page/recipes-r@main/recipes/<cuisine>/<diet>/<slug>.json
```
